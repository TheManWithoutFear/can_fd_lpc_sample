...
outputs:
- {id: CAN_clock.outFreq, value: 60 MHz}
...
- {id: SYSCON.CANCLKDIV.scale, value: '1', locked: true}
...
- {id: SYSCON.PLL0M_MULT.scale, value: '30', locked: true}
- {id: SYSCON.PLL0N_DIV.scale, value: '1', locked: true}
- {id: SYSCON.PLL0_PDEC.scale, value: '8', locked: true}
sources:
